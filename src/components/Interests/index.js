...
import hockeyimage from './hockeyimage.jpg';
import gamingimage from './gamingimage.jpg';

export const Interests = () => (
  <div className='interests'>
    <h1 className='interests-header'>INTERESTS</h1>
    <div className='hockey'>
        <img src={hockeyimage} className='image' alt='hockey-image'/>
